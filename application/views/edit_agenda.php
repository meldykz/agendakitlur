                    ...
                    <div class="page-body">
                        <div class="card">
                            ...
                            <?php foreach ($isi as $u) { ?>
                                <div class="card-body">
                                    <form action="<?= base_url(); ?>agenda/edit/<?= $u->id_agenda ?>" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id_agenda" value="<?= $u->id_agenda ?>">
                                        <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                                            <div class="form-group">
                                                <label for="">Agenda *</label>
                                                <input type="text" value="<?= $u->agenda ?>" name="agenda" class="form-control a" placeholder="Agenda ..." autocomplete="on" autofocus>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-3">
                                                        <input type="date" value="<?= $u->tgl_plak ?>" name="tgl" class="form-control a" placeholder="" autocomplete="on">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?= $u->tempat ?>" name="tempat" class="form-control a" placeholder="Tempat ..." autocomplete="on" autofocus>
                                                <small class="form-text text-danger"><?= form_error('tempat') ?></small>
                                            </div>
                                            <div class="form-group">
                                                <label for="">PIC *</label>
                                                <input type="text" value="<?= $u->pic ?>" name="pic" class="form-control a" placeholder="PIC  ..." autocomplete="on" autofocus>
